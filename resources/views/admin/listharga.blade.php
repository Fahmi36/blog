        ...
        <div class="card-body table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php $no=1 ?>
                    @foreach($data as $key)
                    @if($key->provider=='TRI' AND $key->provider_sub=='REGULER')
                    <tr>    
                       <td class="text-center"><?php echo $no++?></td>
                       <td>{{$key->provider}}</td>
                       @if ($key->provider_sub=="REGULER")
                       <td>Pulsa</td>
                       @else
    ...
    <div class="card-body table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                <?php $no=1 ?>
                @foreach($data as $key)
                @if($key->provider=='TELKOMSEL' AND $key->provider_sub=='REGULER')
                <tr>    
                   <td class="text-center"><?php echo $no++?></td>
                   <td>{{$key->provider}}</td>
                   @if ($key->provider_sub=="REGULER")
        ...
        <div class="card-body table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php $no=1 ?>
                    @foreach($data as $key)
                    @if($key->provider=='INDOSAT' AND $key->provider_sub=='REGULER')
                    <tr>    
                       <td class="text-center"><?php echo $no++?></td>
                       <td>{{$key->provider}}</td>
                       @if ($key->provider_sub=="REGULER")
    ...
    <div class="card-body table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                <?php $no=1 ?>
                @foreach($data as $key)
                @if($key->provider=='AXIS' AND $key->provider_sub=='REGULER')
                <tr>    
                   <td class="text-center"><?php echo $no++?></td>
                   <td>{{$key->provider}}</td>
                   @if ($key->provider_sub=="REGULER")
        ...
        <div class="card-body table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php $no=1 ?>
                    @foreach($data as $key)
                    @if($key->provider=='XL' AND $key->provider_sub=='REGULER')
                    <tr>    
                       <td class="text-center"><?php echo $no++?></td>
                       <td>{{$key->provider}}</td>
                       @if ($key->provider_sub=="REGULER")
    ...
    <div class="card-body table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                <?php $no=1 ?>
                @foreach($data as $key)
                @if($key->provider=='SMARTFREN' AND $key->provider_sub=='REGULER')
                <tr>    
                   <td class="text-center"><?php echo $no++?></td>
                   <td>{{$key->provider}}</td>
                   @if ($key->provider_sub=="REGULER")
        ...
        <div class="card-body table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    <?php $no=1 ?>
                    @foreach($data as $key)
                    @if($key->provider=='BOLT' AND $key->provider_sub=='REGULER')
                    <tr>    
                       <td class="text-center"><?php echo $no++?></td>
                       <td>{{$key->provider}}</td>
                       @if ($key->provider_sub=="REGULER")
